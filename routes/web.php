...
Route::get('/go-studio', function () {
    return Inertia::render('public/go-studio-links');
})->name('public.go-studio');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware([RedirectClientUsersFromStaffArea::class, 'role:superadmin'])->group(function () {
        ...
        Route::get('panel/acceso-credenciales/{entitlement_secret}', [EntitlementSecretsController::class, 'show'])
            ->name('panel.acceso-credenciales.show');
