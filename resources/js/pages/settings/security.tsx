                        ...
                        {twoFactorEnabled ? (
                            <div className="flex flex-col items-start justify-start space-y-4">
                                <p className="text-sm text-muted-foreground">
                                    Se te pedirá un PIN aleatorio y seguro al
                                    iniciar sesión, que podrás obtener desde la
                                    aplicación de autenticación TOTP en tu
                                    celular.
                                </p>

                                <div className="relative inline">
                                    <Form {...inertiaFormProps(disable())}>
                                        {({ processing }) => (
                                            <Button
                                                variant="destructive"
                                                type="submit"
                            ...
                            <div className="flex flex-col items-start justify-start space-y-4">
                                <p className="text-sm text-muted-foreground">
                                    Cuando habilites la autenticación en dos
                                    pasos, se te pedirá un PIN seguro al
                                    iniciar sesión. Este PIN se genera en una
                                    aplicación TOTP en tu celular.
                                </p>
