...
import VentasSuscripcionForm from '@/components/sales/subscriptions/VentasSuscripcionForm';
...
export default function VentasSuscripcionCreatePage({
    usersForSelect,
    skusForSelect,
}: Props) {
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-[11px] text-muted-foreground">
                                Crea una suscripción manualmente para un cliente.
                                Podrás editarla o cancelarla desde el listado.
                            </p>
                        </div>
                    </div>
                </NeuCardRaised>
