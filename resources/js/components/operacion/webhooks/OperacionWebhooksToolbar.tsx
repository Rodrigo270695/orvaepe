...
type Props = {
    ...
    withErrorOnPage: number;
};

export default function OperacionWebhooksToolbar({
    totalEvents,
    rowsCount,
    processedOnPage,
    pendingOnPage,
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-[11px] text-muted-foreground">
                            Eventos recibidos de pasarelas: idempotencia por
                            gateway + ID, payload y estado de procesamiento.
                        </p>
                    </div>
                </div>
            </div>
