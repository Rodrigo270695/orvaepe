...
/**
 * Filtro por rango sobre `created_at` de la cotización (query: `date_from`, `date_to`, formato YYYY-MM-DD).
 */
export default function VentasCotizacionesDateRangeFilter({
    initialDateFrom,
    initialDateTo,
    className,
}: Props) {
