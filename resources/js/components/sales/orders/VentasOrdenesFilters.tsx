...
import VentasOrdenesSearch from '@/components/sales/orders/VentasOrdenesSearch';
...
export default function VentasOrdenesFilters({
    initialQuery,
    initialStatus,
    initialDateFrom,
    initialDateTo,
    ...
    return (
        ...
        >
            <div className="w-full min-w-0 max-w-sm sm:w-auto">
                <VentasOrdenesSearch initialQuery={initialQuery} />
            </div>
            ...
            <div className="w-[min(100%,20rem)] shrink-0 space-y-1.5">
                <AdminUnderlineLabel htmlFor="filter_status">
                    Estado
                </AdminUnderlineLabel>
