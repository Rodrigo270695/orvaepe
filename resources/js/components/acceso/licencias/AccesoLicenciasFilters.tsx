...
export default function AccesoLicenciasFilters({
    initialQuery,
    initialStatus,
    initialDateFrom,
    initialDateTo,
        ...
        >
            <div className="w-full min-w-0 max-w-sm sm:w-auto">
                <VentasSuscripcionesSearch
                    ...
                    placeholder="Cliente, clave, N° pedido…"
                />
            </div>
            ...
            <div className="w-[min(100%,20rem)] shrink-0 space-y-1.5">
                <AdminUnderlineLabel htmlFor="filter_license_status">
                    Estado
                </AdminUnderlineLabel>
                <AdminUnderlineSelect
                    id="filter_license_status"
                    name="filter_license_status"
