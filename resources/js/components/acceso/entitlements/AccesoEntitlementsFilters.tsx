...
export default function AccesoEntitlementsFilters({
    initialQuery,
    initialStatus,
    initialDateFrom,
    initialDateTo,
    ...
    return (
        ...
        >
            ...
            <div className="w-[min(100%,20rem)] shrink-0 space-y-1.5">
                <AdminUnderlineLabel htmlFor="filter_entitlement_status">
                    Estado
                </AdminUnderlineLabel>
                <AdminUnderlineSelect
                    id="filter_entitlement_status"
                    name="filter_entitlement_status"
